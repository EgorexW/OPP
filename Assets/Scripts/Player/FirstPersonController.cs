...
using UnityEngine.InputSystem;
    ...
    {
        [BoxGroup("References")][Required][SerializeField] PlayerControllerInput input;
        ...
        [Tooltip("How far in degrees can you move the camera up")] public float TopClamp = 90.0f;
        ...
        void Move()
        {
            ...
            if (currentHorizontalSpeed < speed - speedOffset ||
                ...
                _speed = Mathf.Lerp(currentHorizontalSpeed, speed * inputMagnitude,
